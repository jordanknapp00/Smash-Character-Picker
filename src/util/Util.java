...
public final class Util {
	...
	/**
	 * <i><code>statsOutput</code></i> is the text field that the
	 * <code>StatsWindow</code> will display. Using this class'
	 * <code>writeToStats</code> method, anything can be written to the stats
	 * window irrespective of whether the stats window is actually open.
	 */
	public static JTextArea statsOutput;
